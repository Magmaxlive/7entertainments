    ...
    <div id="whychooseus" className="py-20 pb-15  px-8 bg-gradient-to-t from-pink-900 to-black">
        <div className="flex flex-col gap-20 lg:gap-15 max-w-[1440px] mx-auto justify-center items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6">
                            ...
                            (
                                <div key={index} className="min-w-[340px] flex flex-col w-full gap-4 items-center backdrop-blur-xl bg-white/10 py-6  px-5 rounded-lg  justify-center transition-transform duration-300 ease-out hover:scale-105">
